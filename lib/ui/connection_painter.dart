...
class ConnectionPainter extends CustomPainter{
  ...
  Offset getPosition(final GlobalObjectKey globalKey) {
    ...
    final offset=renderBox.localToGlobal(Offset.zero,ancestor:( const GlobalObjectKey('STACK').currentContext!.findRenderObject()));
     return  Offset(offset.dx+renderBox.size.width/2, offset.dy+renderBox.size.height/2);
  }
}