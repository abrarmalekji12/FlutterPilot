...
class ConnectionPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final Line line in list) {
      ...
      myPaint.color = ColorAssets.theme.withOpacity(0.1);
      canvas.drawCircle(offset2, 50, myPaint);

      myPaint.color = ColorAssets.theme.withOpacity(0.3);
      canvas.drawCircle(offset2, 25, myPaint);

      myPaint.color = ColorAssets.theme.withOpacity(0.5);
