...
dynamic lookUp(String id) {
  final state=(GlobalObjectKey(id).currentState!);
  if(state is State<TextField>){
    return (((state as dynamic).editableTextKey as GlobalKey).currentWidget as EditableText).controller;
  }
  return ;
}
''';
