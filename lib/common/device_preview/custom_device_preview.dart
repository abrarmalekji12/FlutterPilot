...
class CustomDevicePreview extends StatefulWidget {
  /// Create a new [CustomDevicePreview].
  ...
  @override
  _CustomDevicePreviewState createState() => _CustomDevicePreviewState();
  ...
  static bool _isEnabled(BuildContext context) {
    final state = context.findAncestorStateOfType<_CustomDevicePreviewState>();
  ...
  static Locale? locale(BuildContext context) {
    ...
    return store.state.maybeMap(
      ...
      orElse: () => View.maybeOf(context)?.platformDispatcher.locale,
    );
  }
...
class _CustomDevicePreviewState extends State<CustomDevicePreview> {
  ...
  @override
  void didUpdateWidget(covariant CustomDevicePreview oldWidget) {
          ...
          child: DeviceFrame(
            ...
            screen: VirtualKeyboard(
              ...
              child: Theme(
                ...
                child: MediaQuery(
                  data: CustomDevicePreview._mediaQuery(context),
                  child: Builder(
                    key: _appKey,
                    builder: (context) {
