...
class CustomInteractiveViewer extends StatefulWidget {
  ...
  ///
  /// At the time this is called, the [CustomTransformationController] will have
  ...
  ///
  /// At the time this is called, the [CustomTransformationController] will not have
  ...
  /// [CustomTransformationController.toScene] for how to convert these coordinates to
  ...
  /// A [CustomTransformationController] for the transformation performed on the
  /// child.
  ///
...
class _CustomInteractiveViewerState extends State<CustomInteractiveViewer>
  ...
  Matrix4 _matrixScale(Matrix4 matrix, double scale) {
    ...
    final double clampedTotalScale = clampDouble(
      totalScale,
      widget.minScale,
      widget.scaleNotifier?.maxScaleFactor ?? 2.5,
    );
