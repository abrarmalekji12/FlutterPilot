...
class CDivider extends Component {
  CDivider() : super('Divider', [
    ...
    Parameters.heightParameter()
      ..withDefaultValue(0) .. withDisplayName('indent')..withInfo(NamedParameterInfo('indent')) .. withRequired(false),
    Parameters.heightParameter()
      ..withDefaultValue(0) .. withDisplayName('end-indent')..withInfo(NamedParameterInfo('endIndent')) .. withRequired(false)
  ],);
